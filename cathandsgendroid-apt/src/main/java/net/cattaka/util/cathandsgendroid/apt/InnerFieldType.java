...
public class InnerFieldType {
	...
	public static InnerFieldType createListType(InnerFieldType ift) {
		...
		return new InnerFieldType(false, String.format(Locale.ROOT, "Accessors.createListAccessor(%1$s)", ift.accessor), "BLOB", javaDataType, null);
	}
	public static InnerFieldType createArrayType(InnerFieldType ift) {
        String javaDataType = String.format("%1$s[]", ift.javaDataType);
		return new InnerFieldType(false, String.format(Locale.ROOT, "Accessors.createArrayAccessor(%1$s)", ift.accessor), "BLOB", javaDataType, null);
	}
}
