...
import net.cattaka.util.cathandsgendroid.GenDbHandler.NamingConventions;

@SupportedSourceVersion(SourceVersion.RELEASE_6)
@SupportedAnnotationTypes("net.cattaka.util.cathandsgendroid.*")
public class CatHandsGendroidProcessor extends AbstractProcessor {
    ...
    public void processElement(TypeElement srcElement) {
        ...
        try {
            ...
            pw.println("import net.cattaka.util.cathandsgendroid.Accessor;");
    ...
    public void writeCursorFunc(Messager messager, PrintWriter pw, EnvironmentBundle bundle,
        ...
        List<FieldEntry> targetFieldEntries = new ArrayList<CatHandsGendroidProcessor.FieldEntry>();
        for (FieldEntry fe : bundle.fieldEntries) {
